namespace MyTraining1121AngularDemo.Authorization
{
    ...
    {
        public const string Pages_CustomerUsers = "Pages.CustomerUsers";
        public const string Pages_CustomerUsers_Create = "Pages.CustomerUsers.Create";
        public const string Pages_CustomerUsers_Edit = "Pages.CustomerUsers.Edit";
        public const string Pages_CustomerUsers_Delete = "Pages.CustomerUsers.Delete";
