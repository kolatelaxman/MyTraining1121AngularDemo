...
namespace MyTraining1121AngularDemo.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var customerUsers = pages.CreateChildPermission(AppPermissions.Pages_CustomerUsers, L("CustomerUsers"));
            customerUsers.CreateChildPermission(AppPermissions.Pages_CustomerUsers_Create, L("CreateNewCustomerUser"));
            customerUsers.CreateChildPermission(AppPermissions.Pages_CustomerUsers_Edit, L("EditCustomerUser"));
            customerUsers.CreateChildPermission(AppPermissions.Pages_CustomerUsers_Delete, L("DeleteCustomerUser"));
